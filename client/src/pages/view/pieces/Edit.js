            ...
            <div className="create">
                <div className="create-form">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="text" id="title" name="title" placeholder="Title" value={post.title} onChange={(e) => setTitle(e.target.value)} />
                        <textarea placeholder="Text" name="body" value={post.excrept} id="" cols="30" rows="10" onChange={(e) => setExcrept(e.target.value)} />
